...
model.add(layers.Dense(512, activation='sigmoid', name='sigmoid_1'))
model.add(layers.Dense(256, activation='relu', name='relu_3'))
model.add(layers.Dense(256, activation='relu', name='relu_4'))
