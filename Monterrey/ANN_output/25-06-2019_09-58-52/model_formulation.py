...
model.add(layers.Dense(8, activation='relu', name='relu_1'))
model.add(layers.Dense(8, activation='relu', name='relu_2'))
...
model.add(layers.Dense(8, activation='relu', name='relu_7'))
model.add(layers.Dense(8, activation='relu', name='relu_8'))
